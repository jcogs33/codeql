...
public class StringBuilder extends AbstractStringBuilder implements CharSequence, Serializable
{
    ...
    public StringBuilder delete(int p0, int p1){ return null; } // manual neutral
