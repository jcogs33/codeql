...
public class HashMap<K, V> extends java.util.AbstractMap<K, V> implements Cloneable, Serializable, java.util.Map<K, V>
{
    ...
    public java.util.Set<Map.Entry<K, V>> entrySet(){ return null; } // manual summary
}
